                ...
                Expanded(
                  child: ReusableCard(
                    ...
                    cardChild: IconContent(
                        content: 'MALE', icon: FontAwesomeIcons.mars),
                  ),
                ),
                Expanded(
                  child: ReusableCard(
                    ...
                    colour: selectedGender == Gender.female
                        ...
                        : kInactiveCardColor,
                    cardChild: IconContent(
                        content: 'FEMALE', icon: FontAwesomeIcons.venus),
                  ),
                ),
              ],
            ),
                ...
                children: [Text('HEIGHT', style: kLabelTextStyle),
                  ...
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      inactiveTrackColor: Color(0xFF8D8F98),
          ...
          BottomButton(
            ...
            onTap: (){
              setState(() {
                ...
                // if(double.parse(calc.calculateBMI()) >= 25){
